export const uiText = {
  ...
  dashboard: {
    ...
    calendarTechnicianFallback: "Sin tecnico",
  ...
  technicianDashboard: {
    ...
    subtitle:
      "Consulta tus servicios asignados de hoy y actualiza su estado cuando completes la visita.",
  ...
  serviceOrder: {
    ...
    description:
      "Crea y asigna una nueva orden de servicio con la informacion operativa esencial.",
    fields: {
      client: "Cliente",
      branch: "Sucursal",
      technician: "Tecnico",
      ...
      recurrenceEndDate: "Fecha fin de recurrencia",
    ...
    residentialBranchAuto:
      "Para clientes residenciales se usara automaticamente la sucursal principal.",
    residentialBranchMissing:
      "No fue posible resolver una sucursal principal para este cliente residencial.",
    technicianEmpty:
    ...
    quickCreate: {
      ...
      inlineBranchDescription:
        "Registra una sucursal minima para el cliente seleccionado y vuelve a la orden.",
