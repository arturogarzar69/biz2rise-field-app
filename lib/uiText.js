export const uiText = {
  ...
  serviceList: {
    ...
    subtitle:
      "Consulta citas y órdenes de servicio en una lista operativa y filtra rápidamente por cliente o técnico.",
    emptyTitle: "No hay servicios o citas para mostrar",
    emptyBody:
      "No hay servicios o citas con los filtros seleccionados.",
    itemTypeOrder: "Orden",
    itemTypeAppointment: "Cita",
    itemTypeRecurring: "Recurrente",
    itemTypeOneTime: "Única",
  ...
  technicianDashboard: {
    ...
    subtitle:
      "Consulta tus órdenes asignadas para hoy y los próximos días, ejecuta el servicio y completa el reporte operativo.",
    assignedTo: "Técnico asignado",
    selectedService: "Servicio seleccionado",
    empty: "No tienes órdenes asignadas para hoy y los próximos días.",
    loadError: "No fue posible cargar tus órdenes asignadas.",
    ...
    fields: {
      ...
      serviceDate: "Fecha programada",
      duration: "Duración",
      serviceSummary: "Qué se hizo",
      findings: "Hallazgos",
      recommendations: "Recomendaciones",
      materialsUsed: "Productos utilizados",
      completionNotes: "Notas adicionales"
    },
    fallbacks: {
    ...
    helpers: {
      report:
        "Completa el reporte del servicio con lo realizado, hallazgos y recomendaciones antes de finalizar.",
      privacyNote:
        "Esta vista oculta datos administrativos y de contacto. La protección final también debe reforzarse en backend y RLS antes de producción."
    }
  },
  tabs: {
  ...
  serviceOrder: {
    ...
    fields: {
      ...
      serviceAmountVisibleToTechnician: "Visible para técnico",
      serviceDate: "Fecha de servicio",
      serviceTime: "Hora de servicio",
      duration: "Duración",
    ...
    placeholders: {
      ...
      serviceAmount: "Ingresa un importe opcional",
  ...
  clients: {
    ...
    formCreateBody:
      "Empieza con nombre y teléfono. Agrega solo los datos que necesites y añade direcciones o contactos antes de guardar si hace falta.",
    formEditBody:
